var sources = {
  vod: {
    yospaceValidationPreroll: {
      title: 'Yospace Validation VOD stream with pre-roll',
    ...
    yospaceValidationNoPreroll: {
      title: 'Yospace Validation VOD Stream without pre-roll',
    ...
    noYospaceArtOfMotion: {
      title: 'No Yospace SSAI Art of Motion',
  ...
  linear: {
    foxSports1: {
      title: 'Fox Sports 1 live stream. DO NOT COMMIT - customer asset, valid for 30 days only, US IP required',
